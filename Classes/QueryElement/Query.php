...
class Query  {
	...
	public function renderClause() {
		...
		$fields = explode(',', \TYPO3\CMS\Media\Utility\TcaTable::getInstance()->getSearchableFields());

		foreach ($fields as $field) {
			$fieldType = \TYPO3\CMS\Media\Utility\TcaField::getInstance()->getFieldType($field);
