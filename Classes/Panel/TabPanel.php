 ...
 * @subpackage media
 */
class TabPanel implements \TYPO3\CMS\Media\Panel\PanelInterface {
	...
	/**
	 * @return \TYPO3\CMS\Media\Panel\TabPanel
	 */
...
EOF;
	...
	public function renderItems() {
		...
		foreach ($this->panels as $panel) {
			...
			/** @var $item \TYPO3\CMS\Media\Form\FormInterface */
	 ...
	 *
	 * @throws \TYPO3\CMS\Media\Exception\InvalidKeyInArrayException
	 * @param \TYPO3\CMS\Media\Form\FormInterface $item
	 * @return \TYPO3\CMS\Media\Panel\TabPanel
	 */
	public function addItem(\TYPO3\CMS\Media\Form\FormInterface $item) {
