...
class TcaViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
	...
	public function render(\TYPO3\CMS\Media\Domain\Model\Media $object = NULL, $prefix = NULL) {
		...
		/** @var $panel \TYPO3\CMS\Media\Panel\Panel */
		$panel = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\CMS\Media\Panel\Panel');
		$panel->createPanel(8)->addItem($tabPanel);
		...
		$paragraph->setValue('This panel will contain something');
