...
class SelectFactory extends \TYPO3\CMS\Media\FormFactory\FieldFactory {
	...
	public function get() {
		...
		$additionalAttributes = array(
			'class' => 'span6' . \TYPO3\CMS\Media\Utility\ClientValidation::getInstance()->get($this->fieldName),
		);

		$label = \TYPO3\CMS\Media\Utility\TcaField::getInstance()->getLabel($this->fieldName);
	...
	public function getOptions() {
		$configuration = \TYPO3\CMS\Media\Utility\TcaField::getInstance()->getConfiguration($this->fieldName);
