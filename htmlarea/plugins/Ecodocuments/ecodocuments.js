 ...
 */
HTMLArea.Ecodocuments = Ext.extend(HTMLArea.Plugin, {
	...
	configurePlugin : function(editor) {
		 ...
		 */
		var buttonId = "Ecodocuments";
		var buttonConfiguration = {
			id		: buttonId,
			tooltip		: this.localize("ecodocuments"),
...
//		var node = this.editor.getParentElement();
		...
		/*
		 * true when this is link <a>
		 * false, means it is a selection
		 */
	...
	onUpdateToolbar: function (button, mode, selectionEmpty, ancestors) {
		if (mode === 'wysiwyg' && this.editor.isEditable() && button.itemId === 'Ecodocuments') {
